    ...
    def _insert_recursive(self, current_node, value):
        ...
        if value < current_node.value:
            ...
            if current_node.left is None:
                ...
                # Si el subárbol izquierdo no es None, se llama a la función recursiva con el nodo izquierdo como
                # nodo actual
            ...
            if current_node.right is None:
                ...
                # Si el subárbol derecho no es None, se llama a la función recursiva con el nodo derecho como nodo
                # actual

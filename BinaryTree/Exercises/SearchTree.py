"""
Búsqueda en un árbol binario de búsqueda: Escribir un método que busque
un valor específico en un árbol binario de búsqueda.
"""
...
value_to_find = int(input('Ingrese el valor a buscar dentro del arbol binario: '))
